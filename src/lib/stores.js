...
// Validation helper (kept from original file)
...
export function deleteCustomCard(index) {
  ...
  if (!tagUsed && removed.tag && !['mans', 'mafias', 'cop', 'doctor', 'kamikaze', 'maniac', 'security', 'lawyer', 'agent', 'idiot'].includes(removed.tag)) {
